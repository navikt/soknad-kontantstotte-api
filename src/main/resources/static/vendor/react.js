...
// Track the current IME composition fallback object, if any.
        ...
        /**
         * @param {string} prefix react-specific prefix, eg: Webkit
...
// infinite loop, because it iterates over the newly added props too.
        ...
        if ("development" !== 'production') {
            ...
            var badreactedStyleNamePattern = /^(?:webkit|moz|o)[A-Z]/;
            ...
            var warnBadreactedStyleName = function (name) {
                if (warnedStyleNames.hasOwnProperty(name) && warnedStyleNames[name]) {
                    return;
                }

                warnedStyleNames[name] = true;
                "development" !== 'production' ? warning(false, 'Unsupported react-prefixed style property %s. Did you mean %s?', name, name.charAt(0).toUpperCase() + name.slice(1)) : undefined;
            };
            ...
            var warnValidStyle = function (name, value) {
                ...
                } else if (badreactedStyleNamePattern.test(name)) {
                    warnBadreactedStyleName(name);
...
// the wrong namespace (and will not display).
         ...
         * with all react prefixes, including `ms`.
         *
         * @param {string} string
         * @return {string}
         */
