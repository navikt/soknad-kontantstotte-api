...
public class SøknadTilOppsummeringJsonTest {
    ...
    public void setUp() throws IOException {
        søknadTilOppsummering = new SoknadTilOppsummering(new TekstService("mapping_tekster", "mapping_land", "nb"), innsynServiceClient);
    ...
    private no.nav.kontantstotte.innsending.steg.Person lagPerson() {
        Person tpsPerson = innsynServiceClient.hentPersonInfo(FNR);
        return new no.nav.kontantstotte.innsending.steg.Person(FNR, tpsPerson.getFulltnavn(), "Norge");
    }
}
